...
printf 'waiting ';for i in {1..5}; do printf '.'; sleep 1; done; echo""
...
gcloud compute instances add-metadata terra-insta --zone us-central1-c --metadata-from-file startup-script=startup3.sh --project my-terra-project-9323
